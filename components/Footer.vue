<template>
    <div class="flex items-start w-full min-h-screen dark:bg-gray-800">
        ...
        <footer class="w-full text-gray-700 bg-gray-100 body-font">
            <div
                ...
                <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-start md:pl-20 md:mt-0 md:text-left">
